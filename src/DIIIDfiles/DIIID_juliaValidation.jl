...
begin
    ...
    "PROCESS_IN" => 5, "THRESHOLD_FLAG" => 0, "N_BASIS" => 16, "SCAN_METHOD" => 2, "REJECT_I_PINCH_FLAG" => 0, "REJECT_E_PINCH_FLAG" => 0, "REJECT_TH_PINCH_FLAG" => 0, "REJECT_EP_PINCH_FLAG" => 0,
    ...
    t1 = time()
    cd(outdir) do
        runTHD(dd, rho, OptionsDict; printout = true, saveFiles = true, dir = joinpath(@__DIR__, "fileInput"), use_gpu = use_gpu)
    end
    t2 = time()
