...
#===================================================================================================#
# This driver is what should be ran for running tjlfep on the omega cluster. main.jl is for testing #
#===================================================================================================#
...
for i in 1:n_ir
    #try
        ...
        input1 = arrTGLFEP[i]
        input2 = arrMTGLF[i]
        arrgrowth[i], arrTGLFEP[i], arrMTGLF[i] = TJLFEP.mainsub(input1, input2, true)
    #catch
    #end
end
...
if ((inputTGLFEP.PROCESS_IN == 4) || (inputTGLFEP.PROCESS_IN == 5) || (inputTGLFEP.PROCESS_IN == 6 ))
    ...
    if (inputTGLFEP.THRESHOLD_FLAG == 0)
        ...
        # This function's goal is to determine whether each radial location is being saved in the interpolation
