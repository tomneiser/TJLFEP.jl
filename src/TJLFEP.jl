...
export gamma_dgamma_dfactor, gamma_grad, marginal_factor, marginal_factor_faithful, critical_factor_grid, critical_factor_optimize, critical_factor_profile, gamma_input_sensitivities
