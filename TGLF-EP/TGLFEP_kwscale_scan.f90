...
subroutine TGLFEP_kwscale_scan
  ...
  integer, parameter :: nfactor = 8
  integer, parameter :: nefwid  = 8    ! Distinct from nwidth used in alternate width finder
  integer, parameter :: nkyhat  = 4    ! Distinct from nn used when process_in/=5
...
!      endif
      ...
      call TGLFEP_ky
!      if (i == 51) then
!        print *, 'First ikws:', i, 'proc: ', id, lkeep(1), ltearing(1), l_th_pinch(1), l_i_pinch(1), l_e_pinch(1), l_EP_pinch(1), &
!             l_QL_ratio(1), l_theta_sq(1), f_real(ir)*get_growthrate(1), f_real(ir)*get_frequency(1)
!      endif
...
!      if (i == 51) then
!        print *, 'In loop ',n,' ikws:', i, 'proc: ', id, lkeep(1), ltearing(1), l_th_pinch(1), l_i_pinch(1), l_e_pinch(1), l_EP_pinch(1), &
!             l_QL_ratio(1), l_theta_sq(1), f_real(ir)*get_growthrate(1), f_real(ir)*get_frequency(1)
!      endif
...
!      if (i == 51) then
!        print *, 'Second ikws:', i, 'proc: ', id, lkeep(1), ltearing(1), l_th_pinch(1), l_i_pinch(1), l_e_pinch(1), l_EP_pinch(1), &
!             l_QL_ratio(1), l_theta_sq(1), f_real(ir)*get_growthrate(1), f_real(ir)*get_frequency(1)
!      endif
...
!    if (id_3==0) print 50, 'All after MPI_BARRIER at ', values(5),values(6),values(7)
    ...
    if (ierr .ne. 0) print *, 'growthrate ierr =', ierr, ' on local ', id, ' of ', np, ' ; global id=', id_world
    ...
    if (ierr .ne. 0) print *, 'frequency ierr =', ierr, ' on local ', id, ' of ', np, ' ; global id=', id_world
    ...
    if (ierr .ne. 0) print *, 'lkeep_i ierr =', ierr, ' on local ', id, ' of ', np, ' ; global id=', id_world
    ...
    if (ierr .ne. 0) print *, 'ltearing_i ierr =', ierr, ' on local ', id, ' of ', np, ' ; global id=', id_world
    ...
    if (ierr .ne. 0) print *, 'l_th_pinch_i ierr =', ierr, ' on local ', id, ' of ', np, ' ; global id=', id_world
    ...
    if (ierr .ne. 0) print *, 'l_i_pinch_i ierr =', ierr, ' on local ', id, ' of ', np, ' ; global id=', id_world
    ...
    if (ierr .ne. 0) print *, 'l_e_pinch_i ierr =', ierr, ' on local ', id, ' of ', np, ' ; global id=', id_world
    ...
    if (ierr .ne. 0) print *, 'l_EP_pinch_i ierr =', ierr, ' on local ', id, ' of ', np, ' ; global id=', id_world
...
!                       ierr)
    ...
    if (ierr .ne. 0) print *, 'l_QL_ratio_i ierr =', ierr, ' on local ', id, ' of ', np, ' ; global id=', id_world
    ...
    if (ierr .ne. 0) print *, 'l_theta_sq_i ierr =', ierr, ' on local ', id, ' of ', np, ' ; global id=', id_world

!    print *, 'lkeep values iteration ', k, ' proc: ', id, lkeep(1), lkeep_i(ikyhat,iefwid,ifactor,1), lkeep_i_out(ikyhat,iefwid,ifactor,1)
    
!    call date_and_time(values=values)
!    if (id==0) print 40, id, id_2, id_3, 'after MPI_ALLREDUCE at', values(5),values(6),values(7)
!     print *, 'ikws:', i, 'proc: ', id, lkeep(1), ltearing(1), l_th_pinch(1), l_i_pinch(1), l_e_pinch(1), l_EP_pinch(1), &
!             l_QL_ratio(1), l_theta_sq(1), f_real(ir)*get_growthrate(1), f_real(ir)*get_frequency(1)
...
!          write(88,22)factor(ifactor),(g(n),f(n),keep_label(n),n=1,nmodes),id
...
22 format(F11.4,4(2ES14.5,A4),I4)
