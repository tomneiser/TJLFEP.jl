#!/bin/bash -l
# N_BASIS=16, SCAN_N=20 on 5 GPU nodes: 20 tasks, 4 per node, 1 GPU per task.
#SBATCH -A m3739_g
#SBATCH -q premium
#SBATCH -N 5
#SBATCH -n 20
#SBATCH -t 04:00:00
#SBATCH -C gpu
#SBATCH -J TJLFEP_nb16_s20gpu
#SBATCH -o gacode_nb16_scan20_gpu5_%j.out
#SBATCH -e gacode_nb16_scan20_gpu5_%j.err
...
export TGLFEP_FILE="${TGLFEP_FILE:-${TJLFEP_ROOT}/build/debug_nb16/input_scan20.TGLFEP}"
export OUT_DIR="${TJLFEP_ROOT}/build/gacode_nb16_scan20_${SLURM_JOB_ID}_tasks"

cd "${TJLFEP_ROOT}/build"

echo "=== nb16 SCAN_N=20 on ${SLURM_NNODES:-5} GPU nodes, ${SLURM_NTASKS:-20} tasks ==="
...
echo "=== nb16 scan20 GPU done; outputs in ${OUT_DIR} ==="
