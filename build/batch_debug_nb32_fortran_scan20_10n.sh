#!/bin/bash -l
# Fortran: N_BASIS=32, SCAN_N=20, 10 nodes, 20 MPI ranks.
#SBATCH -A m3739
#SBATCH -q premium
#SBATCH -N 10
#SBATCH -t 06:00:00
#SBATCH -C cpu
#SBATCH -J TGLFEP_nb32_s20
#SBATCH -o debug_nb32_fortran20_10n_%j.out
#SBATCH -e debug_nb32_fortran20_10n_%j.err
#SBATCH --ntasks=20
...
RUN_DIR="${TJLFEP_ROOT}/build/fortran_runs/debug_nb32_scan20_10n_${SLURM_JOB_ID:-local}"
...
echo "=== Fortran nb32 SCAN_N=20 on ${SLURM_NNODES:-10} nodes, ntasks=${SLURM_NTASKS:-20} ==="
