...
#SBATCH -t 01:00:00
#SBATCH -C gpu
#SBATCH -J ad_diag_outlier
#SBATCH -o ad/diag_outlier_%j.out
#SBATCH -e ad/diag_outlier_%j.err
...
stdbuf -oL -eL julia --startup-file=no --project=. -t 8 build/ad/diag_outlier_radii.jl
