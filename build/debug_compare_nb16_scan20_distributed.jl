# N_BASIS=16, SCAN_N=20, multi-node (SlurmClusterManager + pmap).
# Run: sbatch batch_debug_nb16_julia_scan20_10n.sh
...
logmsg("=== nb16 scan20 distributed N_BASIS=16 SCAN_N=$SCAN_N ===")
Pkg.instantiate()
t0 = time()
Pkg.precompile()
...
outdir = abspath(joinpath(@__DIR__, "debug_out_nb16_scan20_$(get(ENV, "SLURM_JOB_ID", "local"))_dist"))
mkpath(outdir)
