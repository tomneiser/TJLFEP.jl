#!/bin/bash -l
# Fortran debug at N_BASIS=6, SCAN_N=20 (20 MPI ranks, 1 node).
#SBATCH -A m3739
#SBATCH -q premium
#SBATCH -N 1
#SBATCH -t 01:00:00
#SBATCH -C cpu
#SBATCH -J TGLFEP_nb6_s20
#SBATCH -o debug_nb6_fortran20_%j.out
#SBATCH -e debug_nb6_fortran20_%j.err
#SBATCH --ntasks=20
...
RUN_DIR="${TJLFEP_ROOT}/build/fortran_runs/debug_nb6_scan20_${SLURM_JOB_ID:-local}"
...
echo "=== Fortran debug nb6 SCAN_N=20 ==="
