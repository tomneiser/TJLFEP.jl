...
const FORTRAN_DIR = get(ENV, "FORTRAN_DIR", joinpath(BUILD, "fortran_runs", "53155032"))
const JULIA_DIR = get(ENV, "JULIA_DIR", joinpath(BUILD, "validate_out_53159242_files_dist"))
const OUTDIR = get(ENV, "PLOT_OUTDIR", joinpath(BUILD, "compare_nb32_scan_plots"))
const FORTRAN_LABEL = get(ENV, "FORTRAN_LABEL", "Fortran")
const JULIA_LABEL = get(ENV, "JULIA_LABEL", "Julia")
const PLOT_TITLE = get(ENV, "PLOT_TITLE", "N_BASIS=32, SCAN_N=20")
