# Single-radius, file-based run (N_BASIS=32, SCAN_N=1, ir=2).
# Run: TJLFEP_FILE_ONLY=1 julia --project=.. -t 64 debug_compare_nb32.jl
...
logmsg("N_BASIS=32 SCAN_N=1 (single radius)")
...
outdir = abspath(joinpath(@__DIR__, "debug_out_nb32_$(get(ENV, "SLURM_JOB_ID", "local"))"))
mkpath(outdir)
